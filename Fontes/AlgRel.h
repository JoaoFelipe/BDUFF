...
/* Descrição: Verifica se val = atrib de acordo com o tipo
   Parâmetros: atrib e val são os valores a serem comparados.
               tipo é o tipo dos atributos, usado para especificar como é a comparação.
   Valor de retorno: Retorna 1 caso a comparação seja verdadeira
                     ou 0 caso contrário*/
...
/* Descrição: Verifica se atrib < val de acordo com o tipo
   Parâmetros: atrib e val são os valores a serem comparados.
               tipo é o tipo dos atributos, usado para especificar como é a comparação.
   Valor de retorno: Retorna 1 caso a comparação seja verdadeira
                     ou 0 caso contrário*/
...
/* Descrição: Verifica se atrib <= c.val de acordo com o tipo
   Parâmetros: atrib e val são os valores a serem comparados.
               tipo é o tipo dos atributos, usado para especificar como é a comparação.
   Valor de retorno: Retorna 1 caso a comparação seja verdadeira
                     ou 0 caso contrário*/
...
/* Descrição: Verifica qual é o operador da condicao c e retorna uma função de comparação
   Parâmetros: c é uma condicao que possui o atributo opr.
   Valor de retorno: Retorna uma função com assinatura COMPARAPTR, definida no typedef*/
